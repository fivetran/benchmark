...
with store_customers as (
  ...
  from store_sales, {{source('src__tpc_ds', 'date_dim')}}, customer
...
catalog_customers as (
  ...
  from catalog_sales, {{source('src__tpc_ds', 'date_dim')}}, customer
...
web_customers as (
  ...
  from web_sales, {{source('src__tpc_ds', 'date_dim')}}, customer
